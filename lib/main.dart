...
colorScheme: ColorScheme.fromSwatch().copyWith(secondary: Color.fromARGB(255, 22, 204, 204)),
scaffoldBackgroundColor: Colors.white,
appBarTheme: AppBarTheme(backgroundColor: Color(0xFF0056b3), foregroundColor: const Color.fromARGB(255, 170, 126, 69)),
),
home: ToDoHomePage(),
...
child: Text("Select Due Date: ${selectedDate.toLocal().toString().split(' ')[0]}"),
)
],
),
),
...
itemBuilder: (ctx, i) {
final task = tasks[i];
final dueSoon = task.dueDate.difference(DateTime.now()).inDays <= 1 &&
!task.isCompleted;
...
onPressed: () => _addTaskDialog(task: task, index: i),
),
IconButton(
